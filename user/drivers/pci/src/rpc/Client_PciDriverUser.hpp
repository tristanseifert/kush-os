...
class PciDriverUserClient {
    ...
    public:
        ...
        virtual std::string GetDeviceAt(const libdriver::pci::BusAddress &address);
        virtual uint32_t ReadCfgSpace32(const libdriver::pci::BusAddress &address, uint16_t offset);
        virtual void WriteCfgSpace32(const libdriver::pci::BusAddress &address, uint16_t offset, uint32_t value);
