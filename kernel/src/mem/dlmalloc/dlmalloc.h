#ifndef _LIBC_MEM_DLMALLOC
#define _LIBC_MEM_DLMALLOC
...
// XXX: disable scheduler yield support for now
#define LACKS_SCHED_H

// prefix methods
#define USE_DL_PREFIX   1

// remove some problematic API in kernel
#define NO_MALLOC_STATS 1
#define NO_MALLINFO     1

// fake ass mmap, no sbrk
#define HAVE_MMAP       1
#define HAVE_MREMAP     0

#define HAVE_MORECORE   0

// allocate 128K at a time
#define DEFAULT_GRANULARITY     (128 * 1024)

// return the page size
#define malloc_getpagesize arch_page_size()

// disable throwing: none of that exceptions nonsense in señor kernel
#define DLTHROW 
